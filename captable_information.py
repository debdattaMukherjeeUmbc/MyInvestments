...
class CapTableInformation(object):
    ...
    def get_captable_information(self, start_date=None):        
        ...
        captable_information = {'date':current_date_str, 'cash_raised':cash_raised, 'total_number_of_shares':total_number_of_shares, 'ownership':ownership}
    ...
    """
    def _ownership_information(self, relevant_investors_info, total_number_of_shares):
    ...
    """
    def _get_merged_investors_information(self, investors_within_timeframe):
